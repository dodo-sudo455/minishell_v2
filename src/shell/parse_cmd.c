 ...
 *		
 */
static int	_parse_redir(t_ctx *c_ref, t_cmd *cmd_ref, t_lst *nod_ref)
{
...
static int	_parse_word(t_ctx *c_ref, t_cmd *cmd_ref, t_lst *nod_ref)
{
	t_token	*tok_ref;
